...
{
    public class FileExtensionToMimeMapper : IFileExtensionToMimeMapper
    {
        private Dictionary<string,string> _mappings;

        public FileExtensionToMimeMapper()
        {
        ...
        private void AddMapping(string extension, string type)
        {
            _mappings.Add(extension, type);
        }

        public string GetMimeType(string fileName)
        {
            var extension = fileName.Substring(fileName.LastIndexOf('.'));
            return _mappings[extension];
        }
    }
}
