...
namespace Shift4Tests.Units
{
        public class ApiClientTests
    {
        ...
        {
            var assemblyVersion = Assembly.Load("Shift4").GetName().Version;
            ...
            httpclientMock.Verify(client => client.AddHeader(It.Is<string>(name => name == "User-Agent"), It.Is<string>(value => value.StartsWith(string.Format("Shift4-NET/{0}", appVersion)))));
